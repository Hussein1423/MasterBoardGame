...
export const DIRECT_QUESTIONS = [
  ...
  },
  {
    ...
    question:
      "ما اسم الشخصية (مُزيل النين) التي استعانت بها عصابة غينيه ريودان من داخل لعبة غريد آيلاند لإبطال وإزالة قيد نين كورابيكا عن قلب كرولو لوسيلفر؟",
    answer: "أبورغين (Abengane / أبنغاني)",
    points: 350,
  },
  {
    id: "dir-aot-marley-cadets-count",
    anime: "Attack on Titan",
    question:
      "كم عدد المرشحين البارزين لوراثة العمالقة في الجيل الثاني (دفعة فالكو وغابي) من محاربي مارلي؟ واذكرهم.",
    answer: "5 مرشحين (غابي براون، فالكو غريس، كولب غريس، أودو، زوفيا)",
    points: 250,
  },
  {
    id: "dir-naruto-mifune-land",
    anime: "Naruto",
    question:
      "إلى أي دولة أو قرية ينتمي القائد ميفوني (Mifune) الذي ترأس مؤتمر الكاغي الخمسة وقاد الفرقة الخامسة في حرب النينجا؟",
    answer: "بلاد الحديد (Land of Iron - دولة الساموراي)",
    points: 250,
  },
];
...
export const SILHOUETTE_QUESTIONS = [
  ...
  {
    id: "sil-bleach-pernida",
    type: "silhouette",
    anime: "Bleach",
    basePoints: 400,
    question: "من هي هذه الشخصية؟",
    initialHint:
      "حُمِل الحرف 'C' من قِبل هذا الكيان كأحد نخبة حرس يوهاباخ الملكي (Schutzstaffel) في الفاندنرايخ.",
    additionalHints: [
      "قاتل قائد الفرقة الحادية عشرة وقائد الفرقة الثانية عشرة.",
      "كُشف عن حقيقته كـ 'اليد اليسرى لملك الأرواح' المتحكمة في التطور والتقدم، متخفياً تحت رداء أبيض طويل قبل أن يظهر كيد عملاقة بسلاسل وأعين متعددة.",
    ],
    characterName: "بيرنيدا بارنكجاس (Pernida Parnkgjas)",
    correctAnswer: "بيرنيدا بارنكجاس (Pernida Parnkgjas)",
    avatarConfig: {
      symbol: "🖐️",
      color: "#37474F",
      hairStyle:
        "رداء أبيض يغطي كامل الجسد يظهر من تحته عينان مضيئتان ثم يتحول إلى يد عملاقة",
    },
  },
];
...
export const SPEED_CHALLENGES = [
...

  {
    ...
    anime: "Bleach",
    title: "أعضاء الحرس الملكي (الشتوتس شتافل)",
    prompt:
      "اذكر 3 من أعضاء الحرس الملكي الخاص بيوهاباخ (Schutzstaffel) في بليتش بالأسماء فقط خلال 30 ثانية.",
    answer:
      "جيرارد فالكيري، ليلي بارو، أسكين ناك لو فار، بيرنيدا بارنكجاس (يمكن أيضاً قبول: يوغرام هاسشفالت، أوريو إيشيدا بعد الترقية).",
    points: 200,
    timeLimit: 30,
  },
